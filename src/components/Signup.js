              ...
              <div className="card rotate" style={{ backgroundColor: 'white', backdropFilter: 'blur(2px)', color: 'black', border: 'none' }}>
                ...
                <form>
                  <div className="form-group mx-3">
                    ...
                    <input type="text" className="form-control login-input" style={{ borderBottom: '1px solid black' }} placeholder="Full Name" required />
                  </div>
                  <div className="form-group mx-3 my-1">
                    <label><strong>Username</strong></label>
                    <input type="text" className="form-control login-input" style={{ borderBottom: '1px solid black' }} placeholder="Username" required />
                  </div>
                  <div className="form-group mx-3 my-1">
                  ...
                  <div className="form-group mx-3 my-1">
                    ...
                    <input type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" style={{ borderBottom: '1px solid black' }} placeholder="Enter email" />
                    <small id="emailHelp" className="form-text text-muted">We'll never share your email with anyone else.</small>
                  </div>
                  <div className="form-group mx-3 my-1">
                    <label><strong>Choose Password</strong></label>
                    <input type="password" className="form-control login-input" style={{ borderBottom: '1px solid black' }} placeholder="Password" required />
                  </div>
                  <div className="form-group mx-3 my-1">
                    <label><strong>Re-enter password</strong></label>
                    <input type="password" className="form-control login-input" style={{ borderBottom: '1px solid black' }} placeholder="Same as password" required />
                  </div>
